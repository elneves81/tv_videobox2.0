-- CreateEnum
CREATE TYPE "Condition" AS ENUM ('NOVO', 'SEMINOVO', 'USADO', 'PARA_REPARO');

-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('VENDA', 'TROCA', 'DOACAO');

-- CreateEnum
CREATE TYPE "Status" AS ENUM ('ACTIVE', 'SOLD', 'INACTIVE');

-- CreateEnum
CREATE TYPE "MessageType" AS ENUM ('TEXT', 'IMAGE', 'PRODUCT_LINK');
